...
export default function CallToAction() {
  ...
  return (
    <div className="bg-[#0d0d0dff] max-w-8xl mx-auto shadow-xl border-2 border-[#1b1b1b] rounded-3xl m-20 w-[80vw] text-white h-[400px] flex justify-between items-center dot relative overflow-hidden group cursor-pointer transition-all duration-500 hover:scale-[1.01]">
