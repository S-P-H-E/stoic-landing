...
export default function CallToAction() {
    ...
    return (
        <div
            ...
            <div className="absolute w-full lg:right-[200px] bottom-[-500px] h-[500px] bg-border rounded-full opacity-0 group-hover:opacity-90 blur-[120px] transition duration-500 z-20"/>
        </div>
    );
}
