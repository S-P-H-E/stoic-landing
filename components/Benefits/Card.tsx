...
export default function Card(){
    const copy = [
        {
            image: <Spline scene="https://prod.spline.design/oqR80zM7-PZjKO9n/scene.splinecode"/>,
            icon: "/icon/edu.png",
        ...
        {
            image: <Spline scene="https://prod.spline.design/hD1qOIBU7NSTHTPr/scene.splinecode" />,
        ...
        {
            image: <Spline scene="https://prod.spline.design/ONlJE-1szacZYp0R/scene.splinecode" />,
        ...
        {
            image: <Spline scene="https://prod.spline.design/Wsz1EEDwBcpFPVgi/scene.splinecode" />,
            icon: "/icon/clock.png",
