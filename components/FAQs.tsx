...
export default function FAQs() {
  ...
  return (
    <>
      ...
      <div className="w-5/6 md:w-3/4 mx-auto max-w-8xl bg-light-gray rounded-2xl px-5 pt-1">
        {faqs.map((faq, index) => (
          <motion.div
            initial="initial"
            variants={fadeInBox}
            ...
            className={clsx("my-4 p-8 cursor-pointer", index === faqs.length - 1 && "border-none", "border-b border-border")}
          >
            <button
