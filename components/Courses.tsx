...
const MyComponent = () => {
    ...
    return (
        <div id={'courses'} className="scroll-my-20 h-full flex flex-col items-center justify-center relative max-w-8xl gap-8 mx-auto">
            ...
            {courses.map((course, index) => (
                    <div className="rounded-lg overflow-hidden border border-[--border] flex flex-col">
