...
export default function BannerMessage() {
 return(
    <div className="h-[600px] flex flex-col items-center justify-center relative w-full my-4 px-8 mx-auto">
        <motion.div initial={{scale: 0.8, opacity: 0}} transition={{type: 'spring', damping: 20}} whileInView={{scale: 1, opacity: 1}} viewport={{once: true}} className='flex flex-col justify-center items-center h-[85%] gap-6 max-w-8xl mx-auto'>
            <h1 className={clsx("text-6xl lg:text-[5.5rem] 2xl:text-8xl lg:leading-[5.5rem] text-center w-full lg:w-[1000px]", font.className)}>
