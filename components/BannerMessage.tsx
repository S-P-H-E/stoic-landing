...
export default function BannerMessage() {
 return(
    <div className="h-[600px] flex flex-col items-center justify-center relative my-4 px-8 mx-auto">
        <motion.div initial={{scale: 0.8, opacity: 0}} transition={{type: 'spring', damping: 20}} whileInView={{scale: 1, opacity: 1}} viewport={{once: true}} className='flex flex-col justify-center items-center gap-10 max-w-8xl mx-auto'>
            <h1 className={clsx("text-6xl lg:text-8xl leading-[5rem] text-center w-full lg:w-[1000px]", font.className)}>
            ...
            <p className='text-[--description] text-base lg:text-xl tracking-widest text-center'>Don&apos;t you want to have a piece of that pie. People are making money everyday <br className="hidden lg:flex"/> and you don&apos;t need 5 billion followers, just a few hundred thousand will do.</p>
            <CountdownButton />
        </motion.div>
